...
void positioningRobots() {
    ...
    for (int i = 0; i < g_GraphicScene.robotShepard.getRobotNumber(); i++) {
        ...
        g_GraphicScene.robotShepard.TeleportMe(currentRobot);
    }
}
...
void creatingWeapons() {
    for (int i = 0; i < g_GraphicScene.robotShepard.getRobotNumber(); i++) {
        ...
        case 1:
            //RED WEAPON = LOS WEAPON - LASER - GREEN
...
int main(int argc, char* argv[]) {
    ...
    g_GraphicScene.robotShepard.setTerrain(terrain);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        if (updateCount > 100) {
            ...
            // Robots Update
            g_GraphicScene.robotShepard.Update(1.f);
        ...
        // Here the MeshObjects posision are updated as the particles
        //for (int i = 0; i < g_GraphicScene.robotShepard.getRobotNumber(); i++) {
            //cRobot* currentRobot = (cRobot*)g_GraphicScene.robotShepard.getRobotFromIndex(i);
